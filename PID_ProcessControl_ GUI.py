...
class TuningThread(QThread): 
    ...
    def getData2(self):
        ...
        #dados = pg.PlotCurveItem(clear=True, pen = pg.mkPen('r', width=2) , name= 'Dados de Processo')
        #fopdt_encontrado = pg.PlotCurveItem(clear=True, pen = pg.mkPen('b', width=2) , name= 'Método da Tangente')
        #TuningWindow.graph1.addLegend()

        #TuningWindow.graph1.addItem(dados)
        #TuningWindow.graph1.addItem(fopdt_encontrado)
        ...
        #TuningThread.change_value2.emit(1)
        ...
        #print(thauplustheta)
        #print(TuningThread.A0)
        #print(TuningThread.A1)
        #print(TuningThread.A2)

        #print(TuningThread.kp)
        #print(TuningThread.taup)
        #print(TuningThread.thetap)
        
        #print(WorkerThread1.kc)
        #print(WorkerThread1.tauI)
        #print(WorkerThread1.tauD)


        #print(TuningThread.A0)
        #print(TuningThread.Asteady)
        #print(TuningThread.kp)
        #print(TuningThread.A1)
        #print(thauplustheta)
        #print(f(thauplustheta))
    
    def update_model(self):
        TuningThread.t2 = TuningThread.count - 1
        #print(TuningThread.t2)
        data = TuningThread.pv[TuningThread.t1:TuningThread.t2+1]
        t = TuningThread.tlist[TuningThread.t1:TuningThread.t2+1]
        u = TuningThread.output[TuningThread.t1:TuningThread.t2+1]
        dataexp = [x - TuningThread.pv[TuningThread.t1] for x in data]
